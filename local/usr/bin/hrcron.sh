#!/bin/ksh
#$Header: /u999/cvsadmin/cms_rep/repository/local/usr/bin/hrcron.sh,v 1.1 2011/01/13 02:38:14 hongh Exp $
# -----------------------------------------------------------------------------------------------
# Script  : cmscron.sh
# Author  : Haipeng Hong
# Changes :
...
_PRG=${0}
_PRGID=`basename ${0}`
_PRG_HEADER="$Id: hrcron.sh,v 1.1 2011/01/13 02:38:14 hongh Exp $"
...
_logfile="${LOCAL_TOP}/log/${_RT_COMM_ARG1}_`date +%Y%m%d%H%M%S`_${$}.log"
